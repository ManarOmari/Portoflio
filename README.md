...
> In this project, I set up a "Portoflio" repository. I create html, css, test files  .I created six branches to be familiar with github , I created Pull request and merge the updates with main branch .
